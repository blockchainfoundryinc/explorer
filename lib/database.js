    ...
    if (address) {
      ...
      if ( hash === 'coinbase' ) {
        ...
        lib.is_unique(address.txs, txid, function(unique, index) {
          ...
          if(asset_guid != null) {
            console.log(`SAVENEW Balances for ${asset_guid} on ${address.a_id}: unallocated: ${asset_balances[asset_guid]} | allocated: ${asset_allocation_balances[asset_guid]}`);
          }
          ...
          if(asset_guid != null) {
            console.log(`UPDATEEXISTING Balances for ${asset_guid} on ${address.a_id}: unallocated: ${asset_balances[asset_guid]} | allocated: ${asset_allocation_balances[asset_guid]}`);
          }
