    ...
    if (address) {
      ...
      if ( hash === 'coinbase' ) {
        ...
        lib.is_unique(address.txs, txid, function(unique, index) {
          ...
          console.log(`Balances for ${asset_guid}: allocated: ${asset_balances[asset_guid]} | unallocated: ${asset_allocation_balances[asset_guid]}`);
          ...
          console.log(`UPDATED Balances for ${asset_guid}: allocated: ${asset_balances[asset_guid]} | unallocated: ${asset_allocation_balances[asset_guid]}`);
