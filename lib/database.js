        ...
        lib.is_unique(address.txs, txid, function(unique, index) {
          ...
          switch(type) {
            ...
            case 'asset_vin':
              ...
              }else if(tx.systx.txtype === 'assetallocationsend' || tx.sys.txtype === 'syscoinburntoassetallocation') {
            ...
            case 'asset_vout':
              ...
              if(asset_balances[asset_guid] === undefined && (tx.systx.txtype === 'assettransfer' || tx.systx.txtype === 'assetactivate')) {
                  asset_balances[asset_guid] = amount;
              }else if(asset_allocation_balances[asset_guid] === undefined && (tx.systx.txtype === 'assetallocationsend' || tx.systx.txtype === 'assetsend' || tx.systx.txtype === 'syscoinburntoassetallocation')) {
                if(tx.systx.txtype === 'assetallocationsend' || tx.systx.txtype === 'syscoinburntoassetallocation') {
                  asset_allocation_balances[asset_guid] = amount;
                ...
                if(tx.systx.txtype === 'assettransfer' || tx.systx.txtype === 'assetactivate' || tx.systx.txtype === 'assetupdate') {
                  asset_balances[asset_guid] += amount;
                }else if(tx.systx.txtype === 'assetallocationsend' || tx.systx.txtype === 'syscoinburntoassetallocation') {
                  asset_allocation_balances[asset_guid] += amount;
                }else if(tx.systx.txtype === 'assetsend') {
