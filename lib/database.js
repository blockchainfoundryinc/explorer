        ...
        lib.is_unique(address.txs, txid, function(unique, index) {
          ...
          if(asset_guid !== null) {
            addressHistory = new AddressHistory({
              a_id: hash,
              txid: txid,
              start_balance: startBalance.toFixed(),
              end_balance: asset_allocation_balances[asset_guid] ? asset_allocation_balances[asset_guid] : 0,
            ...
            addressHistory = new AddressHistory({
              a_id: hash,
              txid: txid,
              start_balance: startBalance.dividedBy(100000000).toFixed(),
              end_balance: received.minus(sent).dividedBy(100000000).toFixed(),
