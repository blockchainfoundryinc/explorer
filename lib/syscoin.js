    ...
    if (assetGuid !== undefined) {
      ...
      switch (sysTx.txtype) {
        ...
        case 'assetactivate':
          ...
          //add an output for the change
          assetOutputs.push({amount: parseFloat(sysTx.balance), address: sysTx.address});
        ...
        case 'assetupdate':
          ...
          if (sysTx.balance) {
            ...
            assetOutputs.push({amount: parseFloat(sysTx.balance), address: getInputAddress(tx).address});
          } else {
